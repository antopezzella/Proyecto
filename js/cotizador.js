...
var datosCliente = new Producto(producto, producto2, nombre, marca, contame, mensaje) 
...
function Producto(producto, producto2, nombre, marca, contame, mensaje)  {
  this.producto = producto;
  this.producto2 = producto2;
  this.nombre = nombre;
  this.marca = marca;
  this.contame = contame;
...
var input3 = document.getElementById("ayudarte");
